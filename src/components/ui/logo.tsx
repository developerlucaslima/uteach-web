...
function Logo({ className, variant, asChild = false, ...props }: LogoProps) {
  ...
  return (
    <Comp className={cn(logoVariants({ variant, className }))} {...props}>
      ...
      <span className="font-bold text-3xl">teach</span>
    </Comp>
  )
}
